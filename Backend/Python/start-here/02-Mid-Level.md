...
A: Without `functools.wraps`, the wrapper function replaces the original's metadat
A:
...
A: A descriptor is an object that defines how attribute access is handled vi
A:
